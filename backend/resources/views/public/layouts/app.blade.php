...
<head>
    @php
        $publicLogoUrl = !empty($siteSettings['logo']) ? asset('storage/'.$siteSettings['logo']) : asset('images/logo-default.svg');
        $publicFaviconUrl = !empty($siteSettings['favicon']) ? asset('storage/'.$siteSettings['favicon']) : asset('images/favicon.ico');
    @endphp
    <meta charset="UTF-8">
